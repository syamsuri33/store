...
<div class="card card-info">
	...
	<div class="card-body">
		<?php echo CHtml::form(Yii::app()->createUrl('vendor/index'), 'get') ?>
		...
		array(
			...
			'buttons' => array(
				'viewCustom' => array(
					...
					'url' => 'Yii::app()->createUrl("vendor/view", array("id"=>$data->Vendor_ID))', // Generate the URL
				...
				'updateCustom' => array(
					...
					'imageUrl' => false, // Disable default image
					'encodeLabel' => false, // Ensure HTML is rendered correctly
					'url' => 'Yii::app()->createUrl("vendor/update", array("id"=>$data->Vendor_ID))', // Generate the URL
				...
				'deleteCustom' => array(
					...
					'imageUrl' => false, // Disable default image
					'encodeLabel' => false, // Ensure HTML is rendered correctly
					'url' => 'Yii::app()->createUrl("vendor/deletes", array("id"=>$data->Vendor_ID))', // Generate the URL
