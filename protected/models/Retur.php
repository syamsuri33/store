 ...
 *
 * The followings are the available columns in table 'retur':
 ...
 */
class Retur extends CActiveRecord
{
  public $startDate;
  public $endDate;
  ...
  public function rules()
  {
    ...
    return array(
      array('Retur_ID', 'required'),
      array('StatusAktif', 'numerical', 'integerOnly' => true),
      array('Retur_ID', 'length', 'max' => 255),
      array('UserCreated_ID, UserUpdated_ID', 'length', 'max' => 100),
      array('TipeRetur', 'length', 'max'=>9),
      array('Tanggal, Created, Updated, startDate, endDate', 'safe'),
      // The following rule is used by search().
      // @todo Please remove those attributes that should not be searched.
      array('Retur_ID, Tanggal, TipeRetur, Created, UserCreated_ID, Updated, UserUpdated_ID, StatusAktif', 'safe', 'on' => 'search'),
    );
  }
  ...
  public function search()
  {
    ...
    $criteria->compare('TipeRetur',$this->TipeRetur,true);
   ...
   * @return Retur the static model class
   */
